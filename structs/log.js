...
function matchmaking() {
  ...
  for (let i in matchmaking.arguments) {
    msg += `${i == "0" ? "" : " "}${matchmaking.arguments[i]}`;
  }

  console.log(`\x1b[32mMATCHMAKING\x1b[0m: ${msg}`);
}

function matchmaking_error() {
  let msg = "";
  ...
  console.log(`\x1b[31mMATCHMAKING-ERROR\x1b[0m: ${msg}`);
}
